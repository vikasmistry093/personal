   ...
   <body>
            ...
            <div class="container">
               <div class="row  p-t-10 p-b-10">
                  <div class="col-xs-6 col-sm-2">
                     <img src="${pageContext.request.contextPath}/resources/images/logo.png" class="img-responsive logo" />
                  </div>
         ...
         <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="item active">
                  <img src="${pageContext.request.contextPath}/resources/images/logo - Copy.jpg" alt="Los Angeles" style="width:100%;">
               ...
               <div class="item">
                  <img src="${pageContext.request.contextPath}/resources/images/logo - Copy.jpg" alt="Chicago" style="width:100%;">
                  <div class="carousel-caption">
                     <h3>Chicago</h3>
               ...
               <div class="item">
                  <img src="${pageContext.request.contextPath}/resources/images/logo - Copy.jpg" alt="New York" style="width:100%;">
                  <div class="carousel-caption">
                     <h3>New York</h3>
      ...
      <div class="container-fluid m-t-30">
          <div class="row">
            ...
            <div class="col-sm-9 product-section">
                <div class="row  m-t-20 m-b-20">
                    <div class="col-sm-3">
                        <img src="${pageContext.request.contextPath}/resources/images/mob-image.jpeg" class="img-responsive" />
                    </div>
                    <div class="col-sm-3">
                        <img src="${pageContext.request.contextPath}/resources/images/mob-image.jpeg" class="img-responsive" />
                    </div>
      ...
      <footer class="footer-section m-t-30 p-t-30 ">
            <div class="container-fluid">
                    ...
                    <div class="row m-b-35">
                       <div class="col-sm-3">
                          <a href="#"><img src="${pageContext.request.contextPath}/resources/images/logo.png" alt="" class="img-responsive m-b-20"></a>
                       </div>
                       <div class="col-sm-3">
